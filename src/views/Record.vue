    ...
    <div class="record_page text-[50px]">
        ...
        <div class="record_content">
            ...
            <div class="record_container">
                <!-- Loading 状态 -->
                <div v-if="orderListLoading" class="record_loading">
                    <van-loading type="spinner" color="#f3d656" size="40px" />
                    <div class="loading_text">{{ t("record.loading") }}</div>
                </div>
                <!-- 数据列表 -->
                <div v-else-if="recordList.length > 0" class="record_list">
        ...
        <RecordDetailPop ref="recordDetailPopRef" :current-record="currentRecord" />
    </div>
</template>
...
const orderListLoading = computed(() => userStore.orderListLoading)
