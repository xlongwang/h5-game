...
export default {
    ...
    withdraw: {
        ...
        progressStep6: 'The withdrawal request has been sent to the Central Bank and the bank is processing it.',
        progressStep7: 'Abnormal bank processing: this withdrawal amount is additional personal income. According to federal regulations, 10% personal income tax is required on the withdrawal amount.',
