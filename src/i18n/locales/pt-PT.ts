...
export default {
    ...
    components: {
        ...
        vipChannelDescription: `Caro utilizador, tem a oportunidade de desfrutar do canal de levantamento rápido VIP gratuitamente uma vez. Deposite $${vipNeedRechargeTotal}.00 agora, o sistema fornecerá canais VIP de levantamento rápido gratuitamente. Use o canal de levantamento rápido VIP, os levantamentos chegam em 5 minutos`,
    ...
    withdraw: {
        ...
        progressStep6: 'O pedido de levantamento foi enviado ao Banco Central e o banco está a processá-lo.',
        progressStep7: 'Processamento bancário anormal: este valor de levantamento é rendimento pessoal adicional. De acordo com as regulamentações federais, é necessário imposto sobre o rendimento pessoal de 10% sobre o valor do levantamento.',
